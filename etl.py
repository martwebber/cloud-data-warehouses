...
def load_staging_tables(cur, conn):
    ...
    for query in copy_table_queries:
        # Execute COPY statement to load data from staging to target
        cur.execute(query)
        # Note: You might want to uncomment the line below to commit changes
        # conn.commit()

def insert_tables(cur, conn):
    """
    Insert data from staging tables into the fact and dimension tables using INSERT INTO SQL commands.
